...
public sealed class TripConfiguration : IEntityTypeConfiguration<Trip>
{
    public void Configure(EntityTypeBuilder<Trip> builder)
    {
        ...
        // trip/request#second-request-rejected-while-active. Two requests arriving together both
        // read "no active trip"; this is what actually holds the line.
        //
        // Note the coupling flagged in design/trip/request.md: the predicate depends on the set of
        // terminal states, which trip/lifecycle owns. Adding a state and forgetting to classify it
