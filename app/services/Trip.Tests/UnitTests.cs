...
public sealed class StateMachineTests
{
    ...
    /// </summary>
    [Fact]
    [Covers("trip/lifecycle", "unpermitted-transition-rejected", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    [Covers("trip/lifecycle", "assigned-to-in-progress", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    [Covers("trip/lifecycle", "in-progress-to-completed", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    ...
    [Fact]
    [Covers("trip/lifecycle", "no-transition-out-of-terminal", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    [Covers("trip/lifecycle", "cancellation-after-completion-rejected", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    ...
    [Fact]
    [Covers("trip/lifecycle", "rider-cancels-before-start", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
    [Covers("trip/lifecycle", "driver-cancels-after-assignment", Scope.Unit, Quantification.Invariant, Oracle.ModelBased)]
...
public sealed class RiderProjectionTests
{
    ...
    /// </summary>
    [Fact]
    [Covers("trip/rider-view", "no-driver-identity-before-assignment", Scope.Unit, Quantification.Invariant)]
    [Covers("trip/rider-view", "no-driver-position-before-assignment", Scope.Unit, Quantification.Invariant)]
    ...
    [Fact]
    [Covers("trip/rider-view", "supply-density-shown-before-assignment", Scope.Unit, Quantification.Invariant)]
    ...
    [Fact]
    [Covers("trip/rider-view", "driver-shown-after-assignment", Scope.Unit, Quantification.Invariant)]
    ...
    [Fact]
    [Covers("trip/rider-view", "no-position-after-completion", Scope.Unit, Quantification.Invariant)]
    [Covers("trip/rider-view", "no-position-after-cancellation", Scope.Unit, Quantification.Invariant)]
    [Covers("trip/rider-view", "driver-identity-remains-on-receipt", Scope.Unit, Quantification.Invariant)]
