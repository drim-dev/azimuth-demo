...
`design/trips/rider-view.md` records that density is computed from real positions and is not
...
`design/trips/rider-view.md`'s second mechanism: `RiderTripStream.Close`, "invoked by the state
