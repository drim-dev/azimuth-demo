# Spec: trip/driver-view

What a driver is shown about an offer and a trip they hold.

The asymmetry with `trip/rider-view` is the point: a driver sees the rider's pickup before
...
Owns driver-facing visibility. Does not own dispatch itself (`trip/dispatch`).

## Invariant: rider-contact-confined-to-held-trips
Criticality: critical
Over: trip/driver-view
...
`trip/rider-view#position-confined-to-live-phases`, which was written after a second surface leaked
