...
so the claim needs qualifying rather than replacing. D3 has not been amended. `status.md` records
this as having fired three times, from when there were three; `unjudged` is the fourth.
